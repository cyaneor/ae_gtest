...
TEST(ae_memory_raw_compare_backward_u8, null_pointers) {
    EXPECT_EQ(ae_memory_raw_compare_backward_u8(nullptr, nullptr, nullptr, nullptr), nullptr);
}

TEST(ae_memory_raw_compare_backward_u8, compare_same_length) {
    ae_u8_t lhs[] = {1, 2, 3, 4, 5};
    ae_u8_t rhs[] = {1, 2, 3, 4, 5};
    ae_usize_t len = sizeof(lhs) / sizeof(lhs[0]);

    EXPECT_EQ(ae_memory_raw_compare_backward_u8(lhs, &lhs[len], rhs, &rhs[len]), nullptr);
}

TEST(ae_memory_raw_compare_backward_u8, compare_different_length) {
    ae_u8_t lhs[] = {1, 2, 3, 4, 5};
    ae_u8_t rhs[] = {1, 2, 3};
    ae_usize_t lhs_len = sizeof(lhs) / sizeof(lhs[0]);
    ae_usize_t rhs_len = sizeof(rhs) / sizeof(rhs[0]);

    EXPECT_EQ(ae_memory_raw_compare_backward_u8(lhs, &lhs[lhs_len], rhs, &rhs[rhs_len]), &lhs[4]);
}

TEST(ae_memory_raw_compare_backward_u8, compare_different_values) {
    ae_u8_t lhs[] = {1, 2, 3, 4, 5};
    ae_u8_t rhs[] = {1, 2, 3, 0, 5};
    ae_usize_t len = sizeof(lhs) / sizeof(lhs[0]);

    EXPECT_EQ(ae_memory_raw_compare_backward_u8(lhs, &lhs[len], rhs, &rhs[len]), &lhs[3]);
}

TEST(ae_memory_raw_compare_backward_u8, empty_array) {
    ae_u8_t rhs[] = {1, 2, 3};
    ae_usize_t rhs_len = sizeof(rhs) / sizeof(rhs[0]);

    EXPECT_EQ(ae_memory_raw_compare_backward_u8(nullptr, nullptr, rhs, &rhs[rhs_len]), nullptr);
}

TEST(ae_memory_raw_compare_backward_u8, compare_equal_after_different_elements) {
    ae_u8_t lhs[] = {1, 2, 3, 4, 5};
    ae_u8_t rhs[] = {6, 7, 8, 4, 5};
    ae_usize_t len = sizeof(lhs) / sizeof(lhs[0]);

    EXPECT_EQ(ae_memory_raw_compare_backward_u8(lhs, &lhs[len], rhs, &rhs[len]), &lhs[2]);
}

TEST(ae_memory_raw_compare_backward_u8, compare_same_last_elements) {
...
TEST(ae_memory_raw_compare_backward_u16, null_pointers) {
    EXPECT_EQ(ae_memory_raw_compare_backward_u16(nullptr, nullptr, nullptr, nullptr), nullptr);
}

TEST(ae_memory_raw_compare_backward_u16, compare_same_length) {
    ae_u16_t lhs[] = {1, 2, 3, 4, 5};
    ae_u16_t rhs[] = {1, 2, 3, 4, 5};
    ae_usize_t len = sizeof(lhs) / sizeof(lhs[0]);

    EXPECT_EQ(ae_memory_raw_compare_backward_u16(lhs, &lhs[len], rhs, &rhs[len]), nullptr);
}

TEST(ae_memory_raw_compare_backward_u16, compare_different_length) {
    ae_u16_t lhs[] = {1, 2, 3, 4, 5};
    ae_u16_t rhs[] = {1, 2, 3};
    ae_usize_t lhs_len = sizeof(lhs) / sizeof(lhs[0]);
    ae_usize_t rhs_len = sizeof(rhs) / sizeof(rhs[0]);

    EXPECT_EQ(ae_memory_raw_compare_backward_u16(lhs, &lhs[lhs_len], rhs, &rhs[rhs_len]), &lhs[4]);
}

TEST(ae_memory_raw_compare_backward_u16, compare_different_values) {
    ae_u16_t lhs[] = {1, 2, 3, 4, 5};
    ae_u16_t rhs[] = {1, 2, 3, 0, 5};
    ae_usize_t len = sizeof(lhs) / sizeof(lhs[0]);

    EXPECT_EQ(ae_memory_raw_compare_backward_u16(lhs, &lhs[len], rhs, &rhs[len]), &lhs[3]);
}

TEST(ae_memory_raw_compare_backward_u16, empty_array) {
    ae_u16_t rhs[] = {1, 2, 3};
    ae_usize_t rhs_len = sizeof(rhs) / sizeof(rhs[0]);

    EXPECT_EQ(ae_memory_raw_compare_backward_u16(nullptr, nullptr, rhs, &rhs[rhs_len]), nullptr);
}

TEST(ae_memory_raw_compare_backward_u16, compare_equal_after_different_elements) {
    ae_u16_t lhs[] = {1, 2, 3, 4, 5};
    ae_u16_t rhs[] = {6, 7, 8, 4, 5};
    ae_usize_t len = sizeof(lhs) / sizeof(lhs[0]);

    EXPECT_EQ(ae_memory_raw_compare_backward_u16(lhs, &lhs[len], rhs, &rhs[len]), &lhs[2]);
}

TEST(ae_memory_raw_compare_backward_u16, compare_same_last_elements) {
...
TEST(ae_memory_raw_compare_backward_u32, null_pointers) {
    EXPECT_EQ(ae_memory_raw_compare_backward_u32(nullptr, nullptr, nullptr, nullptr), nullptr);
}

TEST(ae_memory_raw_compare_backward_u32, compare_same_length) {
    ae_u32_t lhs[] = {1, 2, 3, 4, 5};
    ae_u32_t rhs[] = {1, 2, 3, 4, 5};
    ae_usize_t len = sizeof(lhs) / sizeof(lhs[0]);

    EXPECT_EQ(ae_memory_raw_compare_backward_u32(lhs, &lhs[len], rhs, &rhs[len]), nullptr);
}

TEST(ae_memory_raw_compare_backward_u32, compare_different_length) {
    ae_u32_t lhs[] = {1, 2, 3, 4, 5};
    ae_u32_t rhs[] = {1, 2, 3};
    ae_usize_t lhs_len = sizeof(lhs) / sizeof(lhs[0]);
    ae_usize_t rhs_len = sizeof(rhs) / sizeof(rhs[0]);

    EXPECT_EQ(ae_memory_raw_compare_backward_u32(lhs, &lhs[lhs_len], rhs, &rhs[rhs_len]), &lhs[4]);
}

TEST(ae_memory_raw_compare_backward_u32, compare_different_values) {
    ae_u32_t lhs[] = {1, 2, 3, 4, 5};
    ae_u32_t rhs[] = {1, 2, 3, 0, 5};
    ae_usize_t len = sizeof(lhs) / sizeof(lhs[0]);

    EXPECT_EQ(ae_memory_raw_compare_backward_u32(lhs, &lhs[len], rhs, &rhs[len]), &lhs[3]);
}

TEST(ae_memory_raw_compare_backward_u32, empty_array) {
    ae_u32_t rhs[] = {1, 2, 3};
    ae_usize_t rhs_len = sizeof(rhs) / sizeof(rhs[0]);

    EXPECT_EQ(ae_memory_raw_compare_backward_u32(nullptr, nullptr, rhs, &rhs[rhs_len]), nullptr);
}

TEST(ae_memory_raw_compare_backward_u32, compare_equal_after_different_elements) {
    ae_u32_t lhs[] = {1, 2, 3, 4, 5};
    ae_u32_t rhs[] = {6, 7, 8, 4, 5};
    ae_usize_t len = sizeof(lhs) / sizeof(lhs[0]);

    EXPECT_EQ(ae_memory_raw_compare_backward_u32(lhs, &lhs[len], rhs, &rhs[len]), &lhs[2]);
}

TEST(ae_memory_raw_compare_backward_u32, compare_same_last_elements) {
...
TEST(ae_memory_raw_compare_backward_u64, null_pointers) {
    EXPECT_EQ(ae_memory_raw_compare_backward_u64(nullptr, nullptr, nullptr, nullptr), nullptr);
}

TEST(ae_memory_raw_compare_backward_u64, compare_same_length) {
    ae_u64_t lhs[] = {1, 2, 3, 4, 5};
    ae_u64_t rhs[] = {1, 2, 3, 4, 5};
    ae_usize_t len = sizeof(lhs) / sizeof(lhs[0]);

    EXPECT_EQ(ae_memory_raw_compare_backward_u64(lhs, &lhs[len], rhs, &rhs[len]), nullptr);
}

TEST(ae_memory_raw_compare_backward_u64, compare_different_length) {
    ae_u64_t lhs[] = {1, 2, 3, 4, 5};
    ae_u64_t rhs[] = {1, 2, 3};
    ae_usize_t lhs_len = sizeof(lhs) / sizeof(lhs[0]);
    ae_usize_t rhs_len = sizeof(rhs) / sizeof(rhs[0]);

    EXPECT_EQ(ae_memory_raw_compare_backward_u64(lhs, &lhs[lhs_len], rhs, &rhs[rhs_len]), &lhs[4]);
}

TEST(ae_memory_raw_compare_backward_u64, compare_different_values) {
    ae_u64_t lhs[] = {1, 2, 3, 4, 5};
    ae_u64_t rhs[] = {1, 2, 3, 0, 5};
    ae_usize_t len = sizeof(lhs) / sizeof(lhs[0]);

    EXPECT_EQ(ae_memory_raw_compare_backward_u64(lhs, &lhs[len], rhs, &rhs[len]), &lhs[3]);
}

TEST(ae_memory_raw_compare_backward_u64, empty_array) {
    ae_u64_t rhs[] = {1, 2, 3};
    ae_usize_t rhs_len = sizeof(rhs) / sizeof(rhs[0]);

    EXPECT_EQ(ae_memory_raw_compare_backward_u64(nullptr, nullptr, rhs, &rhs[rhs_len]), nullptr);
}

TEST(ae_memory_raw_compare_backward_u64, compare_equal_after_different_elements) {
    ae_u64_t lhs[] = {1, 2, 3, 4, 5};
    ae_u64_t rhs[] = {6, 7, 8, 4, 5};
    ae_usize_t len = sizeof(lhs) / sizeof(lhs[0]);

    EXPECT_EQ(ae_memory_raw_compare_backward_u64(lhs, &lhs[len], rhs, &rhs[len]), &lhs[2]);
}

TEST(ae_memory_raw_compare_backward_u64, compare_same_last_elements) {
...
TEST(ae_memory_raw_copy_backward_u8, null_pointers) {
    EXPECT_EQ(ae_memory_raw_copy_backward_u8(nullptr, nullptr, nullptr, nullptr), nullptr);
}

TEST(ae_memory_raw_copy_backward_u8, copy_same_length) {
    ae_u8_t src[] = {1, 2, 3, 4, 5};
    ae_u8_t dst[5] = {};
    ae_usize_t len = sizeof(src) / sizeof(src[0]);

    ae_u8_t *result = ae_memory_raw_copy_backward_u8(dst, &dst[len], src, &src[len]);
    EXPECT_EQ(result, dst);

    EXPECT_TRUE(!memcmp(src, dst, len));
}

TEST(ae_memory_raw_copy_backward_u8, copy_short_to_long) {
    ae_u8_t src[] = {1, 2, 3};
    ae_u8_t dst[5] = {};
    ae_usize_t src_len = sizeof(src) / sizeof(src[0]);
    ae_usize_t dst_len = sizeof(dst) / sizeof(dst[0]);

    ae_u8_t *result = ae_memory_raw_copy_backward_u8(dst, &dst[dst_len], src, &src[src_len]);
...
TEST(ae_memory_raw_copy_backward_u8, copy_long_to_short) {
    ae_u8_t src[] = {1, 2, 3, 4, 5};
    ae_u8_t dst[3] = {};
    ae_usize_t src_len = sizeof(src) / sizeof(src[0]);
    ae_usize_t dst_len = sizeof(dst) / sizeof(dst[0]);
...
TEST(ae_memory_raw_copy_backward_u8, correct_copy) {
    ae_u8_t src[] = {10, 20, 30, 40, 50};
    ae_u8_t dst[5] = {};
    ae_usize_t len = sizeof(src) / sizeof(src[0]);
...
TEST(ae_memory_raw_copy_backward_u16, null_pointers) {
    EXPECT_EQ(ae_memory_raw_copy_backward_u16(nullptr, nullptr, nullptr, nullptr), nullptr);
}

TEST(ae_memory_raw_copy_backward_u16, copy_same_length) {
    ae_u16_t src[] = {1, 2, 3, 4, 5};
    ae_u16_t dst[5] = {};
    ae_usize_t len = sizeof(src) / sizeof(src[0]);

    ae_u16_t *result = ae_memory_raw_copy_backward_u16(dst, &dst[len], src, &src[len]);
    EXPECT_EQ(result, dst);

    EXPECT_TRUE(!memcmp(src, dst, len));
}

TEST(ae_memory_raw_copy_backward_u16, copy_short_to_long) {
    ae_u16_t src[] = {1, 2, 3};
    ae_u16_t dst[5] = {};
    ae_usize_t src_len = sizeof(src) / sizeof(src[0]);
    ae_usize_t dst_len = sizeof(dst) / sizeof(dst[0]);

    ae_u16_t *result = ae_memory_raw_copy_backward_u16(dst, &dst[dst_len], src, &src[src_len]);
    EXPECT_EQ(result, dst + (dst_len - src_len));
...
TEST(ae_memory_raw_copy_backward_u16, copy_long_to_short) {
    ae_u16_t src[] = {1, 2, 3, 4, 5};
    ae_u16_t dst[3] = {};
    ae_usize_t src_len = sizeof(src) / sizeof(src[0]);
    ae_usize_t dst_len = sizeof(dst) / sizeof(dst[0]);
...
TEST(ae_memory_raw_copy_backward_u16, correct_copy) {
    ae_u16_t src[] = {10, 20, 30, 40, 50};
    ae_u16_t dst[5] = {};
    ae_usize_t len = sizeof(src) / sizeof(src[0]);
...
TEST(ae_memory_raw_copy_backward_u32, null_pointers) {
    EXPECT_EQ(ae_memory_raw_copy_backward_u32(nullptr, nullptr, nullptr, nullptr), nullptr);
}

TEST(ae_memory_raw_copy_backward_u32, copy_same_length) {
    ae_u32_t src[] = {1, 2, 3, 4, 5};
    ae_u32_t dst[5] = {};
    ae_usize_t len = sizeof(src) / sizeof(src[0]);

    ae_u32_t *result = ae_memory_raw_copy_backward_u32(dst, &dst[len], src, &src[len]);
    EXPECT_EQ(result, dst);

    EXPECT_TRUE(!memcmp(src, dst, len));
}

TEST(ae_memory_raw_copy_backward_u32, copy_short_to_long) {
    ae_u32_t src[] = {1, 2, 3};
    ae_u32_t dst[5] = {};
    ae_usize_t src_len = sizeof(src) / sizeof(src[0]);
    ae_usize_t dst_len = sizeof(dst) / sizeof(dst[0]);

    ae_u32_t *result = ae_memory_raw_copy_backward_u32(dst, &dst[dst_len], src, &src[src_len]);
    EXPECT_EQ(result, dst + (dst_len - src_len));
...
TEST(ae_memory_raw_copy_backward_u32, copy_long_to_short) {
    ae_u32_t src[] = {1, 2, 3, 4, 5};
    ae_u32_t dst[3] = {};
    ae_usize_t src_len = sizeof(src) / sizeof(src[0]);
    ae_usize_t dst_len = sizeof(dst) / sizeof(dst[0]);
...
TEST(ae_memory_raw_copy_backward_u32, correct_copy) {
    ae_u32_t src[] = {10, 20, 30, 40, 50};
    ae_u32_t dst[5] = {};
    ae_usize_t len = sizeof(src) / sizeof(src[0]);
...
TEST(ae_memory_raw_copy_backward_u64, null_pointers) {
    EXPECT_EQ(ae_memory_raw_copy_backward_u64(nullptr, nullptr, nullptr, nullptr), nullptr);
}

TEST(ae_memory_raw_copy_backward_u64, copy_same_length) {
    ae_u64_t src[] = {1, 2, 3, 4, 5};
    ae_u64_t dst[5] = {};
    ae_usize_t len = sizeof(src) / sizeof(src[0]);

    ae_u64_t *result = ae_memory_raw_copy_backward_u64(dst, &dst[len], src, &src[len]);
    EXPECT_EQ(result, dst);

    EXPECT_TRUE(!memcmp(src, dst, len));
}

TEST(ae_memory_raw_copy_backward_u64, copy_short_to_long) {
    ae_u64_t src[] = {1, 2, 3};
    ae_u64_t dst[5] = {};
    ae_usize_t src_len = sizeof(src) / sizeof(src[0]);
    ae_usize_t dst_len = sizeof(dst) / sizeof(dst[0]);

    ae_u64_t *result = ae_memory_raw_copy_backward_u64(dst, &dst[dst_len], src, &src[src_len]);
    EXPECT_EQ(result, dst + (dst_len - src_len));
...
TEST(ae_memory_raw_copy_backward_u64, copy_long_to_short) {
    ae_u64_t src[] = {1, 2, 3, 4, 5};
    ae_u64_t dst[3] = {};
    ae_usize_t src_len = sizeof(src) / sizeof(src[0]);
    ae_usize_t dst_len = sizeof(dst) / sizeof(dst[0]);
...
TEST(ae_memory_raw_copy_backward_u64, correct_copy) {
    ae_u64_t src[] = {10, 20, 30, 40, 50};
    ae_u64_t dst[5] = {};
    ae_usize_t len = sizeof(src) / sizeof(src[0]);
...
TEST(ae_memory_raw_copy_backward, copy_rev_with64_divisible_length) {
    const size_t len = 64;
    uint8_t src[len];
    uint8_t dst[len];
    ae_u8_t value = 0xAB;
    ...
    memset(src, value, len);
    void *result = ae_memory_raw_copy_backward(dst, &dst[len], src, &src[len]);
    EXPECT_EQ(result, dst);
...
TEST(ae_memory_raw_copy_backward, copy_rev_with32_divisible_length) {
    const size_t len = 32;
    uint8_t src[len];
    uint8_t dst[len];
    ae_u8_t value = 0xCD;
...
TEST(ae_memory_raw_copy_backward, copy_rev_with16_divisible_length) {
    const size_t len = 16;
    uint8_t src[len];
    uint8_t dst[len];
    ae_u8_t value = 0xEF;
...
TEST(ae_memory_raw_copy_backward, copy_rev_with8_divisible_length) {
    const size_t len = 8;
    uint8_t src[len];
    uint8_t dst[len];
    ae_u8_t value = 0xFF;
...
TEST(ae_memory_raw_copy_backward, copy_rev_with_non_divisible_length) {
    const size_t len = 12;
    uint8_t src[len];
    uint8_t dst[len];
    ae_u8_t value = 0x01;
...
TEST(ae_memory_raw_find_backward_u8, find_substring_in_string) {
    ae_u8_t lhs[] = {0x01, 0x02, 0x03, 0x04, 0x05, 0x06};
    ae_u8_t rhs[] = {0x03, 0x04};

    const ae_u8_t *result = ae_memory_raw_find_backward_u8(lhs, &lhs[6], rhs, &rhs[2]);

    ASSERT_NE(result, nullptr);
    EXPECT_EQ(result, lhs + 2);
}

TEST(ae_memory_raw_find_backward_u8, substring_not_found) {
    ae_u8_t lhs[] = {0x01, 0x02, 0x03, 0x04, 0x05, 0x06};
...
TEST(ae_memory_raw_find_backward_u8, find_substring_at_end) {
    ae_u8_t lhs[] = {0x01, 0x02, 0x03, 0x04, 0x05, 0x06};
...
TEST(ae_memory_raw_find_backward_u8, empty_arrays) {
    const ae_u8_t *result = ae_memory_raw_find_backward_u8(nullptr, nullptr, nullptr, nullptr);
...
TEST(ae_memory_raw_find_backward_u8, rhs_longer_than_lhs) {
    ae_u8_t lhs[] = {0x01, 0x02, 0x03};
    ae_u8_t rhs[] = {0x01, 0x02, 0x03, 0x04};

    const ae_u8_t *result = ae_memory_raw_find_backward_u8(lhs, &lhs[3], rhs, &rhs[4]);
    ASSERT_EQ(result, nullptr);
}

TEST(ae_memory_raw_find_backward_u8, null_pointer_check) {
    ae_u8_t lhs[] = {0x01, 0x02, 0x03, 0x04};
    ae_u8_t rhs[] = {0x03, 0x04};

    ae_memory_raw_find_backward_u8(nullptr, &lhs[4], rhs, &rhs[2]);
    EXPECT_EQ(ae_error_get_code_and_clear(ae_runtime_error()),
              AE_RUNTIME_ERROR_NULL_POINTER);
}

TEST(ae_memory_raw_find_backward_u16, find_substring_in_string) {
    ae_u16_t lhs[] = {0x01, 0x02, 0x03, 0x04, 0x05, 0x06};
    ae_u16_t rhs[] = {0x03, 0x04};

    const ae_u16_t *result = ae_memory_raw_find_backward_u16(lhs, &lhs[6], rhs, &rhs[2]);

    ASSERT_NE(result, nullptr);
    EXPECT_EQ(result, lhs + 2);
}

TEST(ae_memory_raw_find_backward_u16, substring_not_found) {
    ae_u16_t lhs[] = {0x01, 0x02, 0x03, 0x04, 0x05, 0x06};
...
TEST(ae_memory_raw_find_backward_u16, find_substring_at_end) {
    ae_u16_t lhs[] = {0x01, 0x02, 0x03, 0x04, 0x05, 0x06};
...
TEST(ae_memory_raw_find_backward_u16, empty_arrays) {
    const ae_u16_t *result = ae_memory_raw_find_backward_u16(nullptr, nullptr, nullptr, nullptr);
...
TEST(ae_memory_raw_find_backward_u16, rhs_longer_than_lhs) {
    ae_u16_t lhs[] = {0x01, 0x02, 0x03};
    ae_u16_t rhs[] = {0x01, 0x02, 0x03, 0x04};

    const ae_u16_t *result = ae_memory_raw_find_backward_u16(lhs, &lhs[3], rhs, &rhs[4]);
    ASSERT_EQ(result, nullptr);
}

TEST(ae_memory_raw_find_backward_u16, null_pointer_check) {
    ae_u16_t lhs[] = {0x01, 0x02, 0x03, 0x04};
    ae_u16_t rhs[] = {0x03, 0x04};

    ae_memory_raw_find_backward_u16(nullptr, &lhs[4], rhs, &rhs[2]);
    EXPECT_EQ(ae_error_get_code_and_clear(ae_runtime_error()),
              AE_RUNTIME_ERROR_NULL_POINTER);
}

TEST(ae_memory_raw_find_backward_u32, find_substring_in_string) {
    ae_u32_t lhs[] = {0x01, 0x02, 0x03, 0x04, 0x05, 0x06};
    ae_u32_t rhs[] = {0x03, 0x04};

    const ae_u32_t *result = ae_memory_raw_find_backward_u32(lhs, &lhs[6], rhs, &rhs[2]);

    ASSERT_NE(result, nullptr);
    EXPECT_EQ(result, lhs + 2);
}

TEST(ae_memory_raw_find_backward_u32, substring_not_found) {
    ae_u32_t lhs[] = {0x01, 0x02, 0x03, 0x04, 0x05, 0x06};
...
TEST(ae_memory_raw_find_backward_u32, find_substring_at_end) {
    ae_u32_t lhs[] = {0x01, 0x02, 0x03, 0x04, 0x05, 0x06};
...
TEST(ae_memory_raw_find_backward_u32, empty_arrays) {
    const ae_u32_t *result = ae_memory_raw_find_backward_u32(nullptr, nullptr, nullptr, nullptr);
...
TEST(ae_memory_raw_find_backward_u32, rhs_longer_than_lhs) {
    ae_u32_t lhs[] = {0x01, 0x02, 0x03};
    ae_u32_t rhs[] = {0x01, 0x02, 0x03, 0x04};

    const ae_u32_t *result = ae_memory_raw_find_backward_u32(lhs, &lhs[3], rhs, &rhs[4]);
    ASSERT_EQ(result, nullptr);
}

TEST(ae_memory_raw_find_backward_u32, null_pointer_check) {
    ae_u32_t lhs[] = {0x01, 0x02, 0x03, 0x04};
    ae_u32_t rhs[] = {0x03, 0x04};

    ae_memory_raw_find_backward_u32(nullptr, &lhs[4], rhs, &rhs[2]);
    EXPECT_EQ(ae_error_get_code_and_clear(ae_runtime_error()),
              AE_RUNTIME_ERROR_NULL_POINTER);
}

TEST(ae_memory_raw_find_backward_u64, find_substring_in_string) {
    ae_u64_t lhs[] = {0x01, 0x02, 0x03, 0x04, 0x05, 0x06};
    ae_u64_t rhs[] = {0x03, 0x04};

    const ae_u64_t *result = ae_memory_raw_find_backward_u64(lhs, &lhs[6], rhs, &rhs[2]);

    ASSERT_NE(result, nullptr);
    EXPECT_EQ(result, lhs + 2);
}

TEST(ae_memory_raw_find_backward_u64, substring_not_found) {
    ae_u64_t lhs[] = {0x01, 0x02, 0x03, 0x04, 0x05, 0x06};
...
TEST(ae_memory_raw_find_backward_u64, find_substring_at_end) {
    ae_u64_t lhs[] = {0x01, 0x02, 0x03, 0x04, 0x05, 0x06};
...
TEST(ae_memory_raw_find_backward_u64, empty_arrays) {
    const ae_u64_t *result = ae_memory_raw_find_backward_u64(nullptr, nullptr, nullptr, nullptr);
...
TEST(ae_memory_raw_find_backward_u64, rhs_longer_than_lhs) {
    ae_u64_t lhs[] = {0x01, 0x02, 0x03};
    ae_u64_t rhs[] = {0x01, 0x02, 0x03, 0x04};

    const ae_u64_t *result = ae_memory_raw_find_backward_u64(lhs, &lhs[3], rhs, &rhs[4]);
    ASSERT_EQ(result, nullptr);
}

TEST(ae_memory_raw_find_backward_u64, null_pointer_check) {
    ae_u64_t lhs[] = {0x01, 0x02, 0x03, 0x04};
    ae_u64_t rhs[] = {0x03, 0x04};

    ae_memory_raw_find_backward_u64(nullptr, &lhs[4], rhs, &rhs[2]);
    EXPECT_EQ(ae_error_get_code_and_clear(ae_runtime_error()),
              AE_RUNTIME_ERROR_NULL_POINTER);
}