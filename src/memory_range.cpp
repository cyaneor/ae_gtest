...
TEST(ae_memory_range_has_ptr_range, contain_range_within_bounds_with_end) {
  ae_memory_range_t range =
      ae_memory_range_initializer(reinterpret_cast<void *>(0x1000), reinterpret_cast<void *>(0x2000));
  ...
  EXPECT_TRUE(ae_memory_range_has_ptr_range(&range, begin, end, true));
}

TEST(ae_memory_range_has_ptr_range, contain_range_with_end) {
  ae_memory_range_t range =
      ae_memory_range_initializer(reinterpret_cast<void *>(0x1000), reinterpret_cast<void *>(0x2000));
...
TEST(ae_memory_range_has_ptr_range, contain_range_outside_bounds) {
  ae_memory_range_t range =
      ae_memory_range_initializer(reinterpret_cast<void *>(0x1000), reinterpret_cast<void *>(0x2000));
  ...
  EXPECT_FALSE(ae_memory_range_has_ptr_range(&range, begin, end, true));
}

TEST(ae_memory_range_has_ptr_range, contain_range_partially_within_bounds) {
  ae_memory_range_t range =
      ae_memory_range_initializer(reinterpret_cast<void *>(0x1000), reinterpret_cast<void *>(0x2000));
...
TEST(ae_memory_range_has_ptr_range, contain_range_with_begin_outside) {
  ae_memory_range_t range =
      ae_memory_range_initializer(reinterpret_cast<void *>(0x1000), reinterpret_cast<void *>(0x2000));
...
TEST(ae_memory_range_has_ptr_range, contain_range_without_end) {
  ae_memory_range_t range =
      ae_memory_range_initializer(reinterpret_cast<void *>(0x1000), reinterpret_cast<void *>(0x2000));
  ...
  EXPECT_FALSE(ae_memory_range_has_ptr_range(&range, begin, end, false));
}
