...
TEST(ae_str_raw_shift_left_with, shift_zero)
{
    ae_char_t str[] = "Hello";
    ae_usize_t len = strlen(str);
    ae_char_t *result = ae_str_raw_shift_left_with(str, len, 0);
    EXPECT_STREQ(result, "Hello");
}

TEST(ae_str_raw_shift_left_with, shift_equal_to_length)
{
    ae_char_t str[] = "Hello";
    ae_usize_t len = strlen(str);
    ae_char_t *result = ae_str_raw_shift_left_with(str, len, len);
    EXPECT_STREQ(result, "\0");
}

TEST(ae_str_raw_shift_left_with, shift_greater_than_length)
{
    ae_char_t str[] = "Hello";
    ae_usize_t len = strlen(str);
    ae_char_t *result = ae_str_raw_shift_left_with(str, len, len + 1);
    EXPECT_STREQ(result, "\0");
}

TEST(ae_str_raw_shift_left_with, shift_by_one)
{
    ae_char_t str[] = "Hello";
    ae_usize_t len = strlen(str);
    ae_char_t *result = ae_str_raw_shift_left_with(str, len, 1);
    EXPECT_STREQ(result, "ello");
}

TEST(ae_str_raw_shift_left_with, shift_by_two)
{
    ae_char_t str[] = "Hello";
    ae_usize_t len = strlen(str);
    ae_char_t *result = ae_str_raw_shift_left_with(str, len, 2);
    EXPECT_STREQ(result, "llo");
}

TEST(ae_str_raw_shift_left_with, shift_by_three)
{
    ae_char_t str[] = "Hello";
    ae_usize_t len = strlen(str);
    ae_char_t *result = ae_str_raw_shift_left_with(str, len, 3);
    EXPECT_STREQ(result, "lo");
}

TEST(ae_str_raw_shift_left_with, shift_longer_than_string)
{
    ae_char_t str[] = "Hello";
    ae_usize_t len = strlen(str);
    ae_char_t *result = ae_str_raw_shift_left_with(str, len, 100);
    EXPECT_STREQ(result, "\0");
}
...
TEST(ae_str_raw_shift_right_fill_with, shift_less_than_len)
{
    ae_char_t str[] = "abcdef";
    ae_usize_t len = 6;
    ae_usize_t shift = 2;
    ...
    ae_str_raw_shift_right_fill_with(str, len, shift, value);
    EXPECT_STREQ(str, expected);
}

TEST(ae_str_raw_shift_right_fill_with, shift_greater_than_len)
{
    ae_char_t str[] = "abcdef";
    ae_usize_t len = 6;
    ae_usize_t shift = 8;
...
TEST(ae_str_raw_shift_right_fill_with, no_shift)
{
    ae_char_t str[] = "abcdef";
    ae_usize_t len = 6;
    ae_usize_t shift = 0;
...
TEST(ae_str_raw_shift_right_fill_with, empty_string)
{
    ae_char_t str[] = "";
    ae_usize_t len = 0;
    ae_usize_t shift = 2;
...
TEST(ae_str_raw_shift_right_fill_with, fill_value)
{
    ae_char_t str[] = "hello";
    ae_usize_t len = 5;
    ae_usize_t shift = 3;
...
TEST(ae_str_raw_shift_right_fill_with, edge_case)
{
    ae_char_t str[] = "xyz";
    ae_usize_t len = 3;
    ae_usize_t shift = 3;
...
TEST(ae_str_raw_shift_right_fill_space, shift_less_than_len)
{
    ae_char_t str[] = "abcdef";
    ae_usize_t len = 6;
    ae_usize_t shift = 2;
    ...
    ae_str_raw_shift_right_fill_space(str, len, shift);

    EXPECT_EQ(memcmp(str, expected, len + 1), 0);
}

TEST(ae_str_raw_shift_right_fill_space, shift_greater_than_len)
{
    ae_char_t str[] = "abcdef";
    ae_usize_t len = 6;
    ae_usize_t shift = 8;
...
TEST(ae_str_raw_shift_right_fill_space, no_shift)
{
    ae_char_t str[] = "abcdef";
    ae_usize_t len = 6;
    ae_usize_t shift = 0;
...
TEST(ae_str_raw_shift_right_fill_space, empty_string)
{
    ae_char_t str[] = "";
    ae_usize_t len = 0;
    ae_usize_t shift = 2;
...
TEST(ae_str_raw_shift_right_fill_space, fill_space)
{
    ae_char_t str[] = "hello";
    ae_usize_t len = 5;
    ae_usize_t shift = 3;
...
TEST(ae_str_raw_shift_right_fill_space, edge_case)
{
    ae_char_t str[] = "xyz";
    ae_usize_t len = 3;
    ae_usize_t shift = 3;
